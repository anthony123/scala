...
trait StandardScalaSettings {
  ...
  val g =               ChoiceSetting ("-g", "level", "Set level of generated debugging info.", List("none", "source", "line", "vars", "notailcalls"), "line")
  ...
  val target =          ChoiceSetting ("-target", "target", "Target platform for object files.", List("jvm-1.5", "jvm-1.6", "jvm-1.7", "msil"), "jvm-1.5")
